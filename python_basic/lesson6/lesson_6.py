...
#
# # print(users["+33333333"])
# print(users.get("+333333331", "key not exists")) #@ перше це значення, друге що замість нього показати (значення за замовчуванням)
#
# # del users["+55555555"]
...
# print(users["Vasya"]["hobbies"][1]) #@ це поганий варіант звертатись до елементів списку
# print(users["Petya"]["add_data"][2])
#
# print(users.get("Vasya").get("hobbies")[1]) # @ треба звертатись так до елементів списку
...
"""
6.1 - ascii letters
зробити перевірку на те, щоб було обидві літери та інші перевірки, як щоб юзер не вводив першу літеру, яка йде за другою: можна поміняти місцями, тобто виправити
6.2 - zfill для нулів, по суті бібліотеку тайм не треба імпортувати
6.3 - два цикли
