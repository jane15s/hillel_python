...
# @ strip можна використати в дз + можна використовувати "remove пробіл" щоб прибрати пробіл серед словами (ще передивитись той таск з snake_щось там)
...
#     password = "".join(password_raw) # @ теж можна подивитись для дз
#
...
### штука щоб копіювати в буфер обміну (при запуску My text test буде в буфері)
# import os
#
...
# print(numbers)
#
# те що й перше тільки в один рядок
# numbers2 = [random.randint(10, 99) for i in range(5)]
# print(numbers2)
#
#швидше працює, але для немасивних операцій
...
"""
hw 5.1 можна називати змінні з трьох-чотирьох слів з нижнім підкресленням,
але два підкреслення підряд бути не може (False). Також false. true з маленької - прибрати
hw 5.2 скопіювати калькулятор зі сторої домашки й зациклити
5.3 Pascal case з хешом, як ідея, подивитись чи є опція швидко перевести
"""
