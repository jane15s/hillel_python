...
#
#
# @additional_logic #@ це як дописати це у функцію, func() вказує куди (аргумент корневої функції, в якому теж може бути передано аргумент)
# def hello():
#     print("Hello World!")
#
#
...
# current_seconds = 1
#
# @functools - бібліотека, за допомогою якої, можна оптимізувати код нижче
...
#########################
# closure - замыкание  #(@ важливий принцип)
...
"""
10.1 - використати цикл
10.2 - застосувати регулярку
10.3 - простий таск, який треба як база для наступних тем
"""