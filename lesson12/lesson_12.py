...
# доп: написати скрипт для видалення всіх файлів вказаної директорії #@ додатково, що можна зробити
#
...
""""
12_1 в циклі, readline, за допомогою регулярки шукати текст, та записати в новий файл, подивитись код з рядка 425
12_2 - 344 - 418
"""