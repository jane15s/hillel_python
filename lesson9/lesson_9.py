...
# def my_sqrl(number): #@ ось функція, а нижче аналог з використанням lambda
#     return number**2
#
#
# numbers = [1, 2, 3, 4, 5]
# # squared_root = map(lambda x: x**2, numbers) # ось тут те що вище, тільки з використанням lambda
...
"""
9.1 - привести до lower, (можна використати  .count)
9.2. використати *args, функції max, min
"""